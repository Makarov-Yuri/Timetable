...
$NameOfInstitute=trim($NameOfInstitute);

//$Group=125;

//SELECT * FROM `listofgroups` WHERE NumberOfGroup='125' and NameOfInstitute="Институт технологии"
...
$result = $mysqli->query("SELECT * FROM `listofgroups` WHERE NumberOfGroup='".$Group."'

and NameOfInstitute='".$NameOfInstitute."' "); // запрос на выборку
